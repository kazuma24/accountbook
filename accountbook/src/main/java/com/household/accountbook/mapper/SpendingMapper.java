...
public interface SpendingMapper {
	...
	@Insert("INSERT INTO spending ("
			+ "account_id, spending_category_name, "
			+ "spending_amount, spending_year, "
			+ "spending_month, spending_day"
			+ ") VALUES ("
	...
	//指定月のカテゴリごとの合計支出額を取得
	@Select("SELECT account_id, spending_category_name, SUM(spending_amount) AS spending_amount "
			+ "FROM spending "
