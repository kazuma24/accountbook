...
public interface IncomeMapper {
	...
	@Insert("INSERT INTO income (" + "account_id, income_category_name, " + "income_amount, income_year, "
			+ "income_month, income_day" + ") VALUES ("
			+ "#{accountId}, #{incomeCategoryName}, #{incomeAmount}, #{incomeYear}, #{incomeMonth}, #{incomeDay});")
	public void incomeRegister(Income income);

	// 指定月のカテゴリごとの合計収入額を取得
	@Select("SELECT account_id, income_category_name, SUM(income_amount) AS income_amount " + "FROM income "
