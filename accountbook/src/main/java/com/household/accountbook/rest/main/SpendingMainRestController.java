...
public class SpendingMainRestController {
	...
	public Object spendingRegister(@RequestBody Spending spending) {
		...
		try {
			...
			// null 空文字 チェック
			List<Object> requestParams = Arrays.asList(spending.getAccountId(), spending.getSpendingAmount(),
					spending.getSpendingCategoryName(), spending.getSpendingYear(), spending.getSpendingMonth(),
					spending.getSpendingDay());
